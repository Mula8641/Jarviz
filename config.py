...
def load():
    ...
    data["openai_model"]        = os.getenv("OPENAI_MODEL",        data.get("openai_model", "gpt-4o"))
    data["anthropic_api_key"]   = os.getenv("ANTHROPIC_API_KEY",   data.get("anthropic_api_key", ""))
    data["anthropic_model"]     = os.getenv("ANTHROPIC_MODEL",     data.get("anthropic_model", "claude-sonnet-4-6"))
